...
public:
	...
	UPROPERTY(Transient)
	class UMyCharacterMovementComponent* MyCharMovem = nullptr;

	UPROPERTY(EditAnywhere, BlueprintReadWrite) bool Wpressed = false;
	UPROPERTY(EditAnywhere, BlueprintReadWrite) bool Spressed = false;
	UPROPERTY(EditAnywhere, BlueprintReadWrite) bool Apressed = false;
	UPROPERTY(EditAnywhere, BlueprintReadWrite) bool Dpressed = false;
	FVector2D PlayerMovementVector = FVector2D::ZeroVector;
